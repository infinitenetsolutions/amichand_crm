    ...
    {	
      ...
      unset($postData['setting_id']);
        ...
        {	
          ...
          $update_data = $this->Setting->update_data($postData,$setting_id);
            if($update_data)
			 			{
							$data['status']=true;
