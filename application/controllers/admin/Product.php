  ...
  <div class="modal-body">
    ...
    <div class="row mb-1">
       ...
       <div class="col-12">
        ...
        <div class="col-12">
        <label>Comment</label>
        <textarea name="comment" id="" class="form-control"></textarea></div>
    ...
    <div class="spinner_load"><img src="<?= base_url()?>assets\img\loader.gif"></div>
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          <?php $i = 1;foreach ($data as $file_data) {
      ...
      <table class="table table-condenced table-bordered file-repeater">
        ...
        <tbody data-repeater-list="process">
          <tr data-repeater-item>
            ...
            <td><button type="button" data-repeater-delete class="btn btn-icon btn-md btn-danger"><i
