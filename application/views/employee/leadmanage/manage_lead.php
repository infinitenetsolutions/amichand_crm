...
<li class="breadcrumb-item"><a href="javascript:;">Manage Leads</a></li>
</ol>
...
<div class="modal fade" id="editLeadTransfer" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal lead_insert_form" onsubmit="return update_leadTransfer_data(this)" method="post" enctype="multipart/form-data" >
          <div class="row">
            <div class="col-xl-12" id="form-data1">
...
function update_lead_data(form) {
  ...
  function update_leadTransfer_data(form) {
  var formData = $(form).serialize();
  $.ajax({
    url: "<?php echo base_url('admin/Leadmanage/update_leadtransfer'); ?>",
    type: "POST",
    data: formData,
    success: function (data) {
