...
<head>
    <meta charset="utf-8" />
    <title>CRM | <?php echo ucfirst($page);?></title>
...
<style>
	*.btn{
		background-color: <?= $settingData['button_color'] ?> !important;
		border-radius: <?= $settingData['button_color'] ?> !important;
	}

		*.control-label{
		   color: <?= $settingData['text_color'] ?> !important;
		   }
