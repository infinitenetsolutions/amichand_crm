...
<tbody>
    ...
    ?>  
                      ...
                      <td><?php echo $cnt++; ?></td>
                      <td>
                        <select name="dept_id" class="form-control" id="edit_department_<?php echo $row->id; ?>">
...
<!--                 <form id="addForm" method="POST" enctype="multipart/form-data">
 -->                    <div class="modal-content">
                   ...
                   <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/Designation/add_designation">
         ...
         $(document).ready(function(){
                ...
                $(".edit").click(function(){
                   var elmId = $(this).data("id");
                    ...
                    //start ajax 
                      $.ajax({
                          url:"<?php echo base_url();?>admin/Designation/edit_designation/"+elmId,
                          method:"POST",
