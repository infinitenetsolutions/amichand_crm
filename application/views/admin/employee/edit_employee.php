                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <option value="On Employee" <?php if(!empty($employee_item) && $employee_item['employee_type']=='On Employee'){echo 'selected';} ?>>On Employee  </option>					
                                </select>
                                </div>
                            </div>
...
$(document).ready(function(){
 ...
 $('#department').change(function(){
  ...
  {
   $.ajax({
    url:"<?php echo base_url(); ?>Employee/fetch_designation",
    method:"POST",
...
$('#other_email').keyup(function(event) { 
        ...
        //$('#empid_msg').html('You released a key');
          ...
          //alert(other_email);
                    $.ajax({
                          url:"<?php echo base_url();?>Employee/employee_email_exist/",
                          method:"POST",
  ...
  $('#department').change(function(){
     ...
     function showReportToEmployeeList(){
           ...
           var emp_id = $('#emp_id').val(); 
              ...
              {
               $.ajax({
                url:"<?php echo base_url(); ?>Employee/fetch_depart_report_employee",
                method:"POST",
