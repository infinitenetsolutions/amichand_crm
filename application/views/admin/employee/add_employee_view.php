...
<?php endif; ?>
            ...
            <form id="TypeValidation" class="form-horizontal" action="<?php echo base_url(); ?>admin/Employee/add_employee" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="employee_type" id="employeeCategory" style="" required="">
                                        ...
                                        <option value="On Employee">On Employee</option>
                                    </select>
                                </div>
                            </div>
                             <div class="col-md-4">
...
$(document).ready(function(){
 ...
 $('#department').change(function(){
  ...
  {
   $.ajax({
    url:"<?php echo base_url(); ?>admin/Employee/fetch_designation",
    method:"POST",
  ...
  else
  {
   $('#designation').html('<option value="">Select Designation</option>');
      ...
      {
       $.ajax({
        url:"<?php echo base_url(); ?>admin/Employee/fetch_depart_report_employee",
        method:"POST",
        data:{"dept_id":dept_id},
        success:function(data)
        {
    ...
    $('#employee_id').keyup(function(event) { 
        ...
        //$('#empid_msg').html('You released a key');
          ...
          //alert(employee_id);
                    $.ajax({
                          url:"<?php echo base_url();?>admin/Employee/employee_id_exist/",
                          method:"POST",
    ...
    $('#other_email').keyup(function(event) { 
        ...
        //$('#empid_msg').html('You released a key');
          ...
          //alert(other_email);
                    $.ajax({
                          url:"<?php echo base_url();?>admin/Employee/employee_email_exist/",
                          method:"POST",
