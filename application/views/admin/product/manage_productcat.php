...
<div id="content" class="content">
	...
	<div class="panel panel-inverse" id="addproductDiv">
		...
		<form action="<?=site_url('admin/product/addproductcategory')?>" method="post" >
			<div class="panel-body">
				<div class="form-group row m-b-15">
					...
					<div class="col-md-4">
						...
						<textarea name="p_desc" class="form-control m-b-5" rows="5" cols="40"></textarea>
					</div>
			...
			<table id="data-table-combine" class="table table-striped table-bordered table-td-valign-middle">
				<thead>
					<tr>
						...
						<th class="text-nowrap" data-searchable="true">Description</th>
